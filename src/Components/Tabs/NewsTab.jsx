...
export function NewsTab() {
   ...
   const fetchData = async (cId, pdx) => {
      ...
      const news = res.data.data.filter((article) => article.video === null)
      if (res.data.data.length === 0 || news.length === 0) {
      ...
      if (pageIndex === 1) {
         ...
         setAllArticles([...allArticles, ...news])
      }
      setIsLoading(false)
   }
   ...
   return (
      <div className="h-[70vh] pr-2 pl-3 overflow-auto" id="scrollableDiv">
